...
files = os.path.join("C:\cygwin64\home\mubeen.gulzar\IRSMDv1.0_Windows\IRSMDv1.0\Output\ScanReports\ProductionScanReports"+now, "*.csv")
...
combinecsv.to_csv( "C:\cygwin64\home\mubeen.gulzar\IRSMDv1.0_Windows\IRSMDv1.0\Output\CombinedReports\CombinedReport"+now+".csv", index=False, encoding='utf-8')
