...
class SearchEngine(object):
    ...
    def output(self, output=out.PRINT, path=None): # This is not the actual output/write code for some reason, actual code is in multiple_search_engines.py
